        ...
        <div className="ls-wrap ls-grid">
          ...
          <div>
            ...
            <div className="ls-block">
              ...
              {/* Photograph leads here — the one chapter where you meet his
                  face before you read a word about him. */}
        ...
        <div className="ls-wrap ls-grid">
          ...
          <div>
            <div className="ls-block">
              ...
              {/* No side-by-side here. The prose runs at its own measure and
                  the photograph sits under it at full column width, so the
                  chapter reads as a page rather than a two-column slot. */}
              <div className="ls-prose" style={{ marginTop: 'clamp(2rem, 5vh, 3rem)', maxWidth: '62ch' }}>
                <p className="ls-lede ls-drop">
                  ...
                  professionally as a middleweight boxer. In the years between
                  the two world wars, he was regarded as one of the greatest
                  middleweight boxers of his generation.
                </p>
                <p>
            ...
            {/* The record, with him standing next to it. */}
            <div className="ls-block">
                ...
                <div>
                  ...
                  <div className="ls-prose" style={{ marginTop: 'clamp(1.25rem, 3vh, 2rem)' }}>
                    <p>
                      ...
                      record rivals that of boxing greats — Muhammad Ali won 56
                      of his 61 bouts, and Manny Pacquiao won 62 of his 72.
                    </p>
                  </div>
                  <StatCompare />
                </div>
            ...
            <div className="ls-block">
              ...
              <div className="ls-prose" style={{ marginTop: 'clamp(1.75rem, 4vh, 2.5rem)', maxWidth: '62ch' }}>
                <p>
                  ...
                  Britain&apos;s{' '}
                  <strong>&lsquo;uncrowned champion&rsquo;</strong>. Because of
                  Rule 24 he was denied a British title — the British Boxing
                  Board of Control would not sanction a championship bout for
                  him.
                </p>
              </div>
            </div>
          ...
          <div>
              ...
              <div className="ls-cols ls-cols-2">
                ...
                <div className="ls-prose">
                  <p>
                    ...
                    groups, the Home Secretary Winston Churchill used the courts
                    to prevent the bout in September 1911. This action was
                    followed by a formal colour bar in British boxing that was
                    repealed in 1947, finally ending in 1948.
                  </p>
                </div>
              </div>
            ...
            <div className="ls-block">
              ...
              <PullQuote dark attribution="LEN JOHNSON, THE DAILY DISPATCH, 1930">
                ...
                Albert Hall, from the National Sporting club and from all fights
                where this is big money. The prejudice against colour has
                prevented me from getting a championship bout, although I
        ...
        <div className="ls-wrap ls-grid">
          ...
          <div>
            <div className="ls-block">
              ...
              {/* The room comes first here — the Congress is the subject, Len is
